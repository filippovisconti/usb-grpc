...
grpc_insecure_channel_create_from_usb_type grpc_insecure_channel_create_from_usb_import;
grpc_server_add_insecure_channel_from_usb_type grpc_server_add_insecure_channel_from_usb_import;
...
void grpc_rb_load_imports(HMODULE library) {
  ...
  grpc_insecure_channel_create_from_usb_import = (grpc_insecure_channel_create_from_usb_type) GetProcAddress(library, "grpc_insecure_channel_create_from_usb");
  grpc_server_add_insecure_channel_from_usb_import = (grpc_server_add_insecure_channel_from_usb_type) GetProcAddress(library, "grpc_server_add_insecure_channel_from_usb");
