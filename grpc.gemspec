...
Gem::Specification.new do |s|
  ...
  s.files += %w( include/grpc/grpc_usb.h )
  ...
  s.files += %w( src/core/ext/transport/chttp2/client/insecure/channel_create_usb.cc )
  ...
  s.files += %w( src/core/ext/transport/chttp2/server/insecure/server_chttp2_usb.cc )
  ...
  s.files += %w( src/core/lib/iomgr/usb_endpoint.cc )
